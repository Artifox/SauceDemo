...
public class SideBarMenuPage extends BaseModal {
    ...
    public static final By CLOSE_MENU_BUTTON = By.id("react-burger-cross-btn");
    ...
    public ProductsPage closeSideBarMenu() {
        WebElement closeButton = wait.until(ExpectedConditions.visibilityOfElementLocated(CLOSE_MENU_BUTTON));
        closeButton.click();
